...
-- 2024-11-26,ADearing,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_ADearing')
	 Begin 
	  Alter Database [Assignment07DB_ADearing] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_ADearing;
	 End
	Create Database Assignment07DB_ADearing;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_ADearing;
